...
class MainActivity : BaseActivity() {
    ...
    lateinit var usualFragment: UsualFragment
    var position = 0
    ...
    private fun initToolbar() {
        ...
        arrayList?.run {
            add(MenuBean(R.mipmap.qianduan_icon, "前端"))
            add(MenuBean(R.mipmap.qianduan_icon, "Android"))
            add(MenuBean(R.mipmap.qianduan_icon, "Ios"))
            add(MenuBean(R.mipmap.qianduan_icon, "拓展资源"))
            add(MenuBean(R.mipmap.qianduan_icon, "休息视频"))
            add(MenuBean(R.mipmap.qianduan_icon, "妹子"))
        }
